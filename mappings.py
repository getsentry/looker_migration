...
("product_facts", "product_usage_sdk"): {
    ...
    "projects_data_outcomes.daily_spans_accepted":              "sdk_base_events.spans",
    "projects_data_outcomes.errors_accepted":                   "sdk_base_events.errors",
    "projects_data_outcomes.events_accepted":                   "sdk_base_events.events",
    "projects_data_outcomes.frontend_profile_duration_accepted": "sdk_base_events.profile_duration_frontend",
    "projects_data_outcomes.logs_bytes_accepted":               "sdk_base_events.log_size_bytes",
    "projects_data_outcomes.logs_items_accepted":               "sdk_base_events.logs",
    "projects_data_outcomes.metrics_accepted":                  "sdk_base_events.trace_metric_items",
    "projects_data_outcomes.profile_duration_accepted":         "sdk_base_events.profile_duration_backend",
    "projects_data_outcomes.profiles_accepted":                 "sdk_base_events.profiles",
    "projects_data_outcomes.replays_accepted":                  "sdk_base_events.replays",
    "projects_data_outcomes.sessions_accepted":                 "sdk_base_events.total_sessions",
    "projects_data_outcomes.trace_metric_items_accepted":       "sdk_base_events.trace_metric_items",
    "projects_data_outcomes.transactions_accepted":             "sdk_base_events.transactions",
