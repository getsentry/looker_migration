...
FIELD_MAP = {
    ...
    # === additional mappings ===
    "seer_analytic_event_usage.issue_details_viewed": "users_seer.issue_details_viewed",
    "product_facts.dt_week": "product_facts_v2_base.dt_week",
    "per_product_trial_flags.in_seer_trial": "organizations_seer.in_seer_trial",
    "sentry_organizationoptions_new.seer_code_review_beta": "organizations_feature_flags.seer_code_review_beta",
    ...
    "seer_analytic_event_usage.solution_code": "users_seer.solution_code",
    "seer_analytic_event_usage.root_cause_find_solution": "users_seer.root_cause_find_solution",
    "seer_analytic_event_usage.issue_viewed_with_solution": "users_seer.issue_viewed_with_solution",
    "seer_analytic_event_usage.create_pr_clicked": "users_seer.create_pr_clicked",
    "seer_analytic_event_usage.push_to_branch_or_pr_setup": "users_seer.push_to_branch_or_pr_setup",
    "seer_analytic_event_usage.deep_dive_panel_views": "users_seer.deep_dive_panel_views",
    "seer_analytic_event_usage.agent_instructions_given": "users_seer.agent_instructions_given",
    "seer_analytic_event_usage.start_fix_clicked": "users_seer.start_fix_clicked",
    "seer_analytic_event_usage.issue_viewed_with_rca": "users_seer.issue_viewed_with_rca",
    ...
    "user_details.given_name": "users_seer.given_name",
    "seer_analytic_event_usage.pr_merged": "users_seer.pr_merged",
    "seer_analytic_event_usage.total_usage": "users_seer.total_usage",
    "seer_analytic_event_usage.user_id": "users_seer.user_id",
    "user_details.full_name": "users_seer.full_name",
    "subscriptions_v3.total_churn_arr": "daily_arr_combined.total_churn_arr",
    ...
    "seer_analytic_event_usage.is_most_active_seer_user": "users_seer.is_most_active_seer_user",
    ...
    "user_details.username": "users_seer.username",
    ...
    "product_facts_org_rca_feedback.rca_negative_feedback": "organizations_feedback_received.rca_negative_feedback",
    "product_facts_org_rca_feedback.rca_positive_feedback": "organizations_feedback_received.rca_positive_feedback",
    "product_facts_org_rca_feedback.changes_negative_feedback": "organizations_feedback_received.changes_negative_feedback",
    "product_facts_org_rca_feedback.changes_positive_feedback": "organizations_feedback_received.changes_positive_feedback",
    "product_facts_org_rca_feedback.solution_positive_feedback": "organizations_feedback_received.solution_positive_feedback",
    "product_facts_org_rca_feedback.solution_negative_feedback": "organizations_feedback_received.solution_negative_feedback",
    ...
    "product_facts.trace_metric_items_accepted_28d": "organizations_events.trace_metric_items_accepted_28d",
    "metric_type_events.metric_items": "projects_data_outcomes.metric_items",
    "metric_type_events.metric_bytes": "projects_data_outcomes.metric_bytes",
    "data_by_sdk.trace_metric_size_bytes_28d": "sdk_base_events.trace_metric_size_bytes_28d",
    "data_by_sdkversion.trace_metric_items": "sdk_base_events.trace_metric_items",
    "data_by_sdk.trace_metric_items_28d": "sdk_base_events.trace_metric_items_28d",
    ...
    "data_by_sdkversion.median_metric_size_bytes": "sdk_base_events.median_metric_size_bytes",
    "metric_type_events.median_size_bytes": "projects_data_outcomes.median_size_bytes",
    ...
    "product_facts.is_last_day_of_fiscal_quarter": "organizations_age_tracking.is_last_day_of_fiscal_quarter",
    "product_facts.dt_fiscal_quarter": "organizations_age_tracking.dt_fiscal_quarter",
    "install_base_cohorts.platform_only_errors_engaged": "organizations_analytics_summary.platform_only_errors_engaged",
    "install_base_cohorts._27k_23k": "organizations_analytics_summary._27k_23k",
    "install_base_cohorts.top_paid_ss": "organizations_analytics_summary.top_paid_ss",
    "install_base_cohorts.top_ai": "organizations_analytics_summary.top_ai",
    "install_base_cohorts.js_cohort": "organizations_analytics_summary.js_cohort",
    "install_base_cohorts.other_ai": "organizations_analytics_summary.other_ai",
    "install_base_cohorts.higher_tier": "organizations_analytics_summary.higher_tier",
    "install_base_cohorts.top_tracing": "organizations_analytics_summary.top_tracing",
    "install_base_cohorts.likely_ai_adoption": "organizations_analytics_summary.likely_ai_adoption",
    "install_base_cohorts.power_users": "organizations_analytics_summary.power_users",
    "install_base_cohorts.sales_led_cx": "organizations_analytics_summary.sales_led_cx",
    "install_base_cohorts.fortune_global_mobile_apps": "organizations_analytics_summary.fortune_global_mobile_apps",
    "product_facts_promocodeclaimant.date_added_month": "organizations_promocode_usage.date_added_month",
    "product_facts_promocodeclaimant.date_added_date": "organizations_promocode_usage.date_added_date",
    "product_facts_promocodeclaimant.promocode": "organizations_promocode_usage.promocode",
    "product_facts_promocodeclaimant.date_added_week": "organizations_promocode_usage.date_added_week",
    "product_facts_promocodeclaimant.promocode_id": "organizations_promocode_usage.promocode_id",
    "subscriptions_v3.total_new_arr": "daily_arr_combined.total_new_arr",
    "subscriptions_v3.total_expansion_arr": "daily_arr_combined.total_expansion_arr",
    "product_facts.replays_accepted_28d": "organizations_data_outcomes.replays_accepted_28d",
    "product_facts.errors_accepted_28d": "organizations_data_outcomes.errors_accepted_28d",
    "product_facts.transactions_accepted_28d": "organizations_data_outcomes.transactions_accepted_28d",
    "product_facts.replays_utilization_rate": "organizations_data_outcomes.replays_utilization_rate",
    "product_facts.spans_utilization_rate": "organizations_events.spans_utilization_rate",
    "product_facts.transactions_utilization_rate": "organizations_data_outcomes.transactions_utilization_rate",
    "product_facts.errors_utilization_rate": "organizations_data_outcomes.errors_utilization_rate",
    "product_facts.logs_accepted_28d": "organizations_events.logs_accepted_28d",
    "product_facts.org_active_users_28d": "organizations_age_tracking.org_active_users_28d",
    "product_facts.spans_accepted_28d": "organizations_events.spans_accepted_28d",
    "billing_model.sum_total_churn_arr": "daily_arr_by_category.sum_total_churn_arr",
    "sentry_organizationoptions_new.size_analysis_beta_org": "organizations_feature_flags.size_analysis_beta_org",
    "product_facts_emerge.size_builds_28d": "organizations_emerge.size_builds_28d",
    "product_facts_emerge.size_builds_total": "organizations_emerge.size_builds_total",
    ...
    "product_facts.sum_org_users_total": "organizations_analytics_summary.sum_org_users_total",
    ...
    "product_facts_emerge.distribution_installs_28d": "organizations_emerge.distribution_installs_28d",
    "emerge_first_adoption_dates.first_size_analysis_date_week": "organizations_emerge.first_size_analysis_date_week",
    ...
    "emerge_first_adoption_dates.first_distribution_build_date_date": "organizations_emerge.first_distribution_build_date_date",
    ...
    "product_facts.performance_units_accepted": "organizations_data_outcomes.performance_units_accepted",
    ...
    "data_by_sdkversion.total_profile_duration_continuous": "sdk_base_events.total_profile_duration_continuous",
    ...
    "product_facts.combined_integration_features": "organizations_feature_flags.combined_integration_features",
    "data_by_project.project_name": "projects_base_table.project_name",
    "data_by_project.project_id": "projects_base_table.project_id",
    "data_by_project.project_count": "projects_base_table.project_count",
    "data_by_project.proj_errors_accepted": "projects_base_table.proj_errors_accepted",
    "data_by_project.has_environments_current_enabled": "projects_base_table.has_environments_current_enabled",
    ...
    "sentry_project.slug": "projects_base_table.slug",
    "product_facts_events.number_of_events_sum": "organizations_events.number_of_events_sum",
    "billing_model_billing_category.sum_contraction_arr": "daily_arr_by_category.sum_contraction_arr",
    "billing_model_billing_category.sum_reactivation_arr": "daily_arr_by_category.sum_reactivation_arr",
    "daily_financial_data_billing_category_struct.change_in_ondemand_arr": "daily_financial_data_billing_category.change_in_ondemand_arr",
    "billing_model_billing_category.sum_churn_arr": "daily_arr_by_category.sum_churn_arr",
    "billing_model_billing_category.sum_new_arr": "daily_arr_by_category.sum_new_arr",
    "billing_model.billing_model": "daily_arr_by_category.billing_model",
    "billing_model_billing_category.sum_expansion_arr": "daily_arr_by_category.sum_expansion_arr",
    "product_facts.first_continuous_profile_date_date": "organizations_feature_adoption_dates.first_continuous_profile_date_date",
    "product_facts.profile_duration_accepted_28d": "organizations_events.profile_duration_accepted_28d",
    "product_facts.frontend_profile_duration_accepted_28d": "organizations_events.frontend_profile_duration_accepted_28d",
    "product_facts.first_ui_profile_date_date": "organizations_feature_adoption_dates.first_ui_profile_date_date",
    "product_facts.front_end_profile_duration_accepted_sum": "organizations_events.front_end_profile_duration_accepted_sum",
    "product_facts.profile_duration_accepted_sum": "organizations_events.profile_duration_accepted_sum",
    "product_facts.total_profile_duration_accepted_sum": "organizations_events.total_profile_duration_accepted_sum",
    "data_by_sdk.pduration_frontend_28d_sdk_family": "sdk_base_events.pduration_frontend_28d_sdk_family",
    "data_by_sdk.sdk_family": "sdk_base_events.sdk_family",
    "data_by_sdk.pduration_backend_28d_sdk_family": "sdk_base_events.pduration_backend_28d_sdk_family",
    "product_facts.total_profile_duration_accepted_28d": "organizations_events.total_profile_duration_accepted_28d",
    "product_facts.org_active_frontend": "organizations_feature_flags.org_active_frontend",
    "product_facts.sum_indexed_spans_accepted": "organizations_events.sum_indexed_spans_accepted",
    "sentry_organizationoptions_new.key": "organizations_feature_flags.key",
    "sentry_organizationoptions_new.cohort_number": "organizations_feature_flags.cohort_number",
    "product_facts_events.sdk_name": "organizations_events.sdk_name",
    "data_by_sdkversion.number_of_events": "sdk_base_events.number_of_events",
    "product_facts.indexed_spans_accepted_28d": "organizations_events.indexed_spans_accepted_28d",
    "product_facts.seer_issue_scans_accepted_28d": "organizations_seer.seer_issue_scans_accepted_28d",
    "product_facts.seer_issue_fixes_accepted_28d": "organizations_seer.seer_issue_fixes_accepted_28d",
    "product_facts.logs_count_28d": "organizations_events.logs_count_28d",
    "per_product_trials.trial_type": "organizations_analytics_summary.trial_type",
    "product_facts.daily_new_issues_28d_org": "organizations_issues.daily_new_issues_28d_org",
    "product_facts.error_issue_views_28day_agg": "organizations_issues.error_issue_views_28day_agg",
    "product_facts.daily_resolved_issues_28d_org": "organizations_issues.daily_resolved_issues_28d_org",
    "product_facts_events.events_28d": "organizations_events.events_28d",
    "product_facts.org_team_count": "organizations_analytics_summary.org_team_count",
    "product_facts.daily_ignored_issues_28d_org": "organizations_issues.daily_ignored_issues_28d_org",
    "product_facts.profile_issue_views_28day_agg": "organizations_issues.profile_issue_views_28day_agg",
    "product_facts.performance_issue_views_28day_agg": "organizations_issues.performance_issue_views_28day_agg",
    ...
    "product_facts.generated_issue_alerts_28d": "projects_metric_alerts.generated_issue_alerts_28d",
    "product_facts.generated_metric_alerts_28d": "projects_metric_alerts.generated_metric_alerts_28d",
    "product_facts.generated_any_alerts_28d": "projects_metric_alerts.generated_any_alerts_28d",
    "product_facts.sum_logs_accepted": "organizations_events.sum_logs_accepted",
    "data_by_sdkversion.log_size_bytes": "sdk_base_events.log_size_bytes",
    "data_by_sdk.log_size_bytes_28d": "sdk_base_events.log_size_bytes_28d",
    ...
    "trial_view.trial_start_month": "organizations_analytics_summary.trial_start_month",
    "top_projects_by_org.is_top_3_project": "projects_base_table.is_top_3_project",
    "data_by_project.events_accepted_28d": "projects_base_table.events_accepted_28d",
    "data_by_project.proj_seer_issue_scans_accepted_28d": "projects_base_table.proj_seer_issue_scans_accepted_28d",
    "product_facts_csm_score.error_spike_score": "projects_base_table.error_spike_score",
    "product_facts_csm_score.resolved_issues_score": "projects_base_table.resolved_issues_score",
    "product_facts_csm_score.client_side_filtering_score": "projects_base_table.client_side_filtering_score",
    "product_facts_csm_score.suspect_commits_score": "projects_base_table.suspect_commits_score",
    "product_facts_csm_score.code_mapping_enabled_score": "projects_base_table.code_mapping_enabled_score",
    "data_by_project.all_spans_28d": "projects_base_table.all_spans_28d",
    "product_facts_csm_score.releases_date_score": "projects_base_table.releases_date_score",
    "product_facts_csm_score.alert_uses_environment_filter_score": "projects_base_table.alert_uses_environment_filter_score",
    "product_facts_csm_score.data_enrichment_score": "projects_base_table.data_enrichment_score",
    "data_by_project.proj_seer_issue_fixes_accepted_28d": "projects_base_table.proj_seer_issue_fixes_accepted_28d",
    "product_facts_csm_score.alert_messaging_int_score": "projects_base_table.alert_messaging_int_score",
    "product_facts_csm_score.environments_score": "projects_base_table.environments_score",
    "product_facts_csm_score.ownership_rules_score": "projects_base_table.ownership_rules_score",
    "product_facts_csm_score.alert_errors_count_score": "projects_base_table.alert_errors_count_score",
    "product_facts_csm_score.alert_transactional_data_score": "projects_base_table.alert_transactional_data_score",
    "product_facts_csm_score.total_weighted_score": "projects_base_table.total_weighted_score",
    "product_facts_csm_score.initial_setup_score": "projects_base_table.initial_setup_score",
    "product_facts_csm_score.sourcemaps_score": "projects_base_table.sourcemaps_score",
    "product_facts_csm_score.breadcrumbs_score": "projects_base_table.breadcrumbs_score",
    "product_facts_csm_score.releases_with_commits_score": "projects_base_table.releases_with_commits_score",
    "product_facts_csm_score.stacktrace_link_status_score": "projects_base_table.stacktrace_link_status_score",
    "product_facts_csm_score.inbound_filters_score": "projects_base_table.inbound_filters_score",
    "product_facts_csm_score.dashboards_score": "projects_base_table.dashboards_score",
    "data_by_project.all_transactions_28d": "projects_base_table.all_transactions_28d",
    "data_by_project.replays_accepted_28d": "projects_base_table.replays_accepted_28d",
    "product_facts_csm_score.symbolicated_score": "projects_base_table.symbolicated_score",
    "product_facts_csm_score.alert_custom_tags_score": "projects_base_table.alert_custom_tags_score",
    "product_facts_csm_score.scm_score": "projects_base_table.scm_score",
    "product_facts_csm_score.alert_ticketing_integration_score": "projects_base_table.alert_ticketing_integration_score",
    "product_facts_csm_score.team_notification_score": "projects_base_table.team_notification_score",
    "product_facts_csm_score.sso_score": "projects_base_table.sso_score",
    "product_facts_csm_score.alert_regression_score": "projects_base_table.alert_regression_score",
    "product_facts_csm_score.custom_tags_score": "projects_base_table.custom_tags_score",
    "data_by_project.logs_count_28d": "projects_base_table.logs_count_28d",
    "product_facts_csm_score.alerts_and_dashboards_score": "projects_base_table.alerts_and_dashboards_score",
    "product_facts_csm_score.scim_enabled_score": "projects_base_table.scim_enabled_score",
    "user_details_for_analytics.email": "users_seer.email",
    "product_facts.github_integration": "organizations_feature_flags.github_integration",
    ...
    "data_by_sdk.total_accepted_replay_count": "sdk_base_events.total_accepted_replay_count",
    "data_by_sdk.number_of_mobile_replays_28d": "sdk_base_events.number_of_mobile_replays_28d",
    "data_by_sdk.Total_replays_28d": "sdk_base_events.Total_replays_28d",
    "trial_view.next_invoice_channel": "organizations_analytics_summary.next_invoice_channel",
    "product_facts.dt_day_of_week": "organizations_age_tracking.dt_day_of_week",
    "trial_view.next_edition": "organizations_analytics_summary.next_edition",
    "product_facts.org_users_total": "organizations_analytics_summary.org_users_total",
    ...
    "trial_view.trial_start_date": "organizations_analytics_summary.trial_start_date",
    "billing_model.sum_total_new_arr": "daily_arr_by_category.sum_total_new_arr",
    "billing_model.sum_total_expansion_arr": "daily_arr_by_category.sum_total_expansion_arr",
    ...
    "data_by_project.project_first_event_date_date": "projects_base_table.project_first_event_date_date",
    "data_by_project.errors_accepted_28d": "projects_base_table.errors_accepted_28d",
    "data_by_project.transactions_accepted_28d": "projects_base_table.transactions_accepted_28d",
    "data_by_project.proj_seer_issue_fixes_accepted": "projects_base_table.proj_seer_issue_fixes_accepted",
    ...
    "data_by_project.proj_seer_issue_scans_accepted": "projects_base_table.proj_seer_issue_scans_accepted",
    "user_details_for_analytics.full_name": "users_seer.full_name",
    ...
    "data_by_project.proj_replays_accepted": "projects_base_table.proj_replays_accepted",
    "data_by_sdkversion.sdk_version_replays_support_proj": "sdk_base_events.sdk_version_replays_support_proj",
    "sdk_mapping_minversion_project.transaction_support": "sdk_org_events.transaction_support",
    "data_by_sdkversion.sdk_version_crons_support_proj": "sdk_base_events.sdk_version_crons_support_proj",
    ...
    "data_by_sdkversion.sdk_version_profiles_support_proj": "sdk_base_events.sdk_version_profiles_support_proj",
    ...
    "data_by_project.proj_spans_accepted": "projects_base_table.proj_spans_accepted",
    "data_by_sdkversion.sdk_version_transactions_support_proj": "sdk_base_events.sdk_version_transactions_support_proj",
    "data_by_project.profiles_accepted_28d": "projects_base_table.profiles_accepted_28d",
    "data_by_project.attachments_accepted_28d": "projects_base_table.attachments_accepted_28d",
    "data_by_project.spike_protection_disabled": "projects_base_table.spike_protection_disabled",
    "data_by_project.regression_issue_alerts_count": "projects_base_table.regression_issue_alerts_count",
    "data_by_project.sdk_integrations_enabled": "projects_base_table.sdk_integrations_enabled",
    "data_by_project.new_issue_alerts_count": "projects_base_table.new_issue_alerts_count",
    "data_by_project.single_event_issue_percent_28d_proj": "projects_base_table.single_event_issue_percent_28d_proj",
    "data_by_project.messaging_integration_issue_alerts_count": "projects_base_table.messaging_integration_issue_alerts_count",
    "data_by_project.proj_team_member_count": "projects_base_table.proj_team_member_count",
    ...
    "data_by_project.environment_based_metric_alerts_count": "projects_base_table.environment_based_metric_alerts_count",
    "data_by_project.client_side_sampling_used": "projects_base_table.client_side_sampling_used",
    "data_by_project.server_side_filters_used": "projects_base_table.server_side_filters_used",
    "data_by_project.error_spike_metric_alerts_count": "projects_base_table.error_spike_metric_alerts_count",
    "data_by_project.client_side_filters_used": "projects_base_table.client_side_filters_used",
    "data_by_project.error_count_issue_alerts_count": "projects_base_table.error_count_issue_alerts_count",
    "data_by_project.transactional_data_metric_alerts_count": "projects_base_table.transactional_data_metric_alerts_count",
    "data_by_project.custom_tags_issue_alerts_count": "projects_base_table.custom_tags_issue_alerts_count",
    ...
    "product_facts.sso_users_28d": "organizations_sso_configuration.sso_users_28d",
    "product_facts.external_ticket_integration_flag": "organizations_feature_flags.external_ticket_integration_flag",
    "product_facts.sso_status": "organizations_sso_configuration.sso_status",
    "data_by_project.errors_over_quota_quarter_count": "projects_base_table.errors_over_quota_quarter_count",
    "data_by_project.transactions_over_quota_quarter_count": "projects_base_table.transactions_over_quota_quarter_count",
    "data_by_project.spend_allocation_enabled_flag": "projects_base_table.spend_allocation_enabled_flag",
    "data_by_project.replays_over_quota_quarter_count": "projects_base_table.replays_over_quota_quarter_count",
    "data_by_project.create_jira_ticket_issue_alert_count": "projects_base_table.create_jira_ticket_issue_alert_count",
    "data_by_project.daily_resolved_issues_28d_proj": "projects_base_table.daily_resolved_issues_28d_proj",
    "data_by_project.codemapping_enabled": "projects_base_table.codemapping_enabled",
    "data_by_project.daily_new_issues_28d_proj": "projects_base_table.daily_new_issues_28d_proj",
    "data_by_project.releases_created_through_cli": "projects_base_table.releases_created_through_cli",
    "data_by_project.releases_having_commits_associated": "projects_base_table.releases_having_commits_associated",
    "data_by_project.ownership_rules": "projects_base_table.ownership_rules",
    "data_by_project.daily_ignored_issues_28d_proj": "projects_base_table.daily_ignored_issues_28d_proj",
    "user_details_for_analytics.is_superuser": "users_seer.is_superuser",
    "user_details_for_analytics.is_staff": "users_seer.is_staff",
    "product_facts.performance_units_accepted_28d": "organizations_data_outcomes.performance_units_accepted_28d",
    "product_facts.transactions_utilization_rate_avg": "organizations_data_outcomes.transactions_utilization_rate_avg",
    "product_facts.org_active_traces": "organizations_events.org_active_traces",
    "product_facts.spans_utilization_rate_avg": "organizations_events.spans_utilization_rate_avg",
    "accounts_billingmetricusage_on_org.sum_quantity_28d": "accounts_billingmetricusage_on_org.sum_quantity_28d",
    "product_facts.first_spans_date_week": "organizations_feature_adoption_dates.first_spans_date_week",
    ...
    "product_facts.profiles_accepted_28d": "organizations_data_outcomes.profiles_accepted_28d",
    "product_facts.sum_errors_rate_limited": "organizations_data_outcomes.sum_errors_rate_limited",
    "expansion_churn_scores.slug": "daily_arr_combined.slug",
    "product_facts.daily_new_performance_issues_28d_org": "organizations_issues.daily_new_performance_issues_28d_org",
    "product_facts.sum_indexed_transactions_rate_limited": "organizations_data_outcomes.sum_indexed_transactions_rate_limited",
    "product_facts.indexed_transactions_accepted_28d": "organizations_data_outcomes.indexed_transactions_accepted_28d",
    "product_facts.sum_indexed_transactions_filtered": "organizations_data_outcomes.sum_indexed_transactions_filtered",
    "product_facts.sum_errors_filtered": "organizations_data_outcomes.sum_errors_filtered",
    "data_by_sdk.number_of_errors_28d": "sdk_base_events.number_of_errors_28d",
    "data_by_sdk.number_of_transactions_28d": "sdk_base_events.number_of_transactions_28d",
    "data_by_project.indexed_transactions_accepted_28d": "projects_base_table.indexed_transactions_accepted_28d",
    "data_by_sdk.number_of_events_28d": "sdk_base_events.number_of_events_28d",
    "product_facts_alerts_array.primary_alertrule_id_slack": "projects_metric_alerts.primary_alertrule_id_slack",
    "product_facts_alerts_array.primary_alertrule_id_email": "projects_metric_alerts.primary_alertrule_id_email",
    ...
    "product_facts_alerts_array.primary_alertrule_id_sentryapp": "projects_metric_alerts.primary_alertrule_id_sentryapp",
    "product_facts_alerts_array.primary_alertrule_id_active": "projects_metric_alerts.primary_alertrule_id_active",
    "product_facts.github_stacktrace_linked_successes": "organizations_events.github_stacktrace_linked_successes",
    "product_facts.created_dashboard_count": "organizations_dashboards.created_dashboard_count",
    "product_facts.transaction_summary_visit_count": "organizations_dashboards.transaction_summary_visit_count",
    "product_facts.performance_landing_page_visit_count": "organizations_dashboards.performance_landing_page_visit_count",
    "product_facts.opened_discover_query_count": "organizations_feature_flags.opened_discover_query_count",
    "product_facts.viewed_dashboard_count": "organizations_dashboards.viewed_dashboard_count",
    ...
    "data_by_sdk.number_of_events": "sdk_base_events.number_of_events",
    "product_facts.sum_transactions_rate_limited": "organizations_data_outcomes.sum_transactions_rate_limited",
    "product_facts.sum_transactions_accepted": "organizations_data_outcomes.sum_transactions_accepted",
    "product_facts.total_metric_alerts_generated": "projects_metric_alerts.total_metric_alerts_generated",
    "product_facts.total_issue_alerts_generated": "projects_metric_alerts.total_issue_alerts_generated",
    "issues_by_type_struct.daily_new_performance_issues_sum": "issues_org_type.daily_new_performance_issues_sum",
    "issues_by_type_struct.daily_resolved_performance_issues_sum": "issues_org_type.daily_resolved_performance_issues_sum",
    "product_facts.sum_replays_rate_limited": "organizations_data_outcomes.sum_replays_rate_limited",
    ...
    "product_facts.sum_errors_invalid_abuse": "organizations_data_outcomes.sum_errors_invalid_abuse",
    "product_facts.sum_transactions_filtered": "organizations_data_outcomes.sum_transactions_filtered",
    "product_facts.sum_transactions_invalid_abuse": "organizations_data_outcomes.sum_transactions_invalid_abuse",
    "product_facts.discover_activity_count": "organizations_feature_flags.discover_activity_count",
    "data_by_sdk.sessions_crashed_28d": "sdk_base_events.sessions_crashed_28d",
    "data_by_sdk.sessions_abnormal_sum": "sdk_base_events.sessions_abnormal_sum",
    "data_by_sdk.total_sessions_28d": "sdk_base_events.total_sessions_28d",
    "data_by_sdk.crash_free_sessions_28d": "sdk_base_events.crash_free_sessions_28d",
    "data_by_sdk.sessions_crashed_sum": "sdk_base_events.sessions_crashed_sum",
    "data_by_sdk.crash_free_rate_percent": "sdk_base_events.crash_free_rate_percent",
    "data_by_sdk.crash_free_rate": "sdk_base_events.crash_free_rate",
    "data_by_sdk.total_sessions_sum": "sdk_base_events.total_sessions_sum",
    ...
    "product_facts.sum_attachments_accepted": "organizations_data_outcomes.sum_attachments_accepted",
    "product_facts.sum_profiles_accepted": "organizations_data_outcomes.sum_profiles_accepted",
